...
public class GameSceneObjectsReferences : MonoBehaviour
{
    ...
    [SerializeField]
    private AmmoTabDescriptionButton _ammoTabDescriptionButton;
    ...
    [SerializeField] [Space]
    private DropBoxSelectionPanelPlayerAbility[] _dropBoxSelectionPanelPlayerAbilities;
    ...
    [SerializeField]
    private PlayerFeedbackAnnouncer _playerFeedbackAnnouncer;
    ...
    public static AmmoTabDescriptionButton AmmoTabDescriptionButton => Instance._ammoTabDescriptionButton;
    ...
    public static DropBoxSelectionPanelPlayerAbility[] DropBoxSelectionPanelPlayerAbilities => Instance._dropBoxSelectionPanelPlayerAbilities;
    ...
    public static PlayerFeedbackAnnouncer PlayerFeedbackAnnouncer => Instance._playerFeedbackAnnouncer;
