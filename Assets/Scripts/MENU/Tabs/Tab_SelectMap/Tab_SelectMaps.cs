...
public class Tab_SelectMaps : Tab_Base<MyPhotonCallbacks>
{
    ...
    public void ConfirmSelectedMap()
    {
        ...
        {
            MyPhoton.CreateRoom(_tabSelectMapOnline._roomProperties._roomName, _tabSelectMapOnline._roomProperties._password, _tabSelectMapOnline._roomProperties._isPasswordSet);
        }
    }
